...
%%
% model_syn creates the model figure menu for synthetic data.
%
...
uicontrol(...
   ...
   'Enable','Off',...
   'String','Apply',...
   'Callback','mag2data.model.sus_celle=str2num(get(findobj(''Tag'',''edit_syn_model_sus_celle''),''string'')); apply');
uicontrol(...
   'Parent',modelmenu,...
...
uicontrol(...
   ...
   'style','pushbutton',...
   'units','normalized',...
   'Position',[.85 .02 .07 .05],...
   'Enable','Off',...
   'String','OK',...
   'Callback','close (findobj(''Tag'',''modelmenu'')); set(findobj(''Tag'',''syntheticmenu''),''Visible'',''on''); close (findobj(''Tag'',''explmenu''))');
...
set(findobj('Tag','synokbutton'),'Enable','on');