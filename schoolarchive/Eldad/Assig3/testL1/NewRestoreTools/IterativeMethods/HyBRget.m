function o = HyBRget(options,name,default,flag)
%
%   o = HyBRget(options,name,default,flag)
%
...
%
%     param = HyBRget(opts,'RegPar','modGCV');
%
%   returns param = 'modGCV' if the RegPar property is not specified in opts.
%
...
if (nargin == 4) && isequal(flag,'fast')
    o = HyBRgetfast(options,name,default);
    return
end
